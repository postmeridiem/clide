...
Scope note: D-107 commitment 5 later moved the face''s *source* from the primary session to Clide''s own. `face_state.dart` did not change — the seam held, which is the outcome the contract was published for.', 'in_progress', 'medium', NULL, NULL, NULL, '2026-08-08 22:47:54.661', '2026-08-09 10:31:35.090', NULL, '715d42d7945658fe78245d8076ce807b', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY73XR4NJEPDARY06397RVVC', 'epic', '06FY73V6EVHP32P31NQRJCP104', 'Epic A: Clide face renderer — CustomPaint, rain field, glyph cache', 'The pure rendering core: a `ClideFace` widget that draws DeskLock''s glyph face and rain
field from a plain state enum. **No session wiring** — it takes a state in and paints. That
keeps it independently testable and lets it start immediately, in parallel with Epic D.
...
Scope note: D-107 commitment 5 later moved the face''s *source* from the primary session to Clide''s own. `face_state.dart` did not change — the seam held, which is the outcome the contract was published for.', 'done', 'medium', NULL, NULL, NULL, '2026-08-08 22:47:54.661', '2026-08-09 10:31:38.930', NULL, '44984f19496363352f961497ca5163b7', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY8XRM7XGNMSGTRB1CNZAA8R', 'task', '06FY73YPCJVWBXD9YF1JKZEK2W', 'C4: Clide settings category + enable/disable kill switch', 'The off switch. **Blocks Epic D (T-519)** — deliberately, so the thing that spends
subscription quota cannot land before the thing that stops it.
...
- A test asserts that disabling produces a state in which no companion session may run —
  written so it still passes before Epic D exists, and becomes meaningful once it does.
- Labels are catalog strings (D-21/D-102), not literals; coordinate the namespace with C5.', 'in_progress', 'high', NULL, NULL, NULL, '2026-08-09 03:00:37.055', '2026-08-09 10:34:06.140', NULL, '1b1de6d2bc4a72d2421aa0b0497da43a', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY8XRM7XGNMSGTRB1CNZAA8R', 'task', '06FY73YPCJVWBXD9YF1JKZEK2W', 'C4: Clide settings category + enable/disable kill switch', 'The off switch. **Blocks Epic D (T-519)** — deliberately, so the thing that spends
subscription quota cannot land before the thing that stops it.
...
- A test asserts that disabling produces a state in which no companion session may run —
  written so it still passes before Epic D exists, and becomes meaningful once it does.
- Labels are catalog strings (D-21/D-102), not literals; coordinate the namespace with C5.', 'in_progress', 'high', NULL, NULL, NULL, '2026-08-09 03:00:37.055', '2026-08-09 10:34:16.310', NULL, 'c71d0ebd7e5477bad92abfe016f2c3f5', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYBN0EJ3B59YWV2Z9S54PRGG', 'task', '06FY73Z35AYAJQZ4MZMT25DPWC', 'Clide prompt templates — system prompt, observed/direct framing, lifecycle notices', 'Clide''s prompt is the product. Everything else in Epic D is plumbing — this is
where his voice, his restraint, and his sense of what is going on actually live.
Split out of T-519 because "write the system prompt" buried in a plumbing epic
gets three lines of attention and then ships as whatever the first draft was.
...
Weigh it; do not default into it silently.', 'backlog', 'high', NULL, NULL, 'D-107', '2026-08-09 09:21:47.664', '2026-08-09 11:33:59.551', NULL, '866ae98a5eb292997e61731fa79658ce', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY8XRM7XGNMSGTRB1CNZAA8R', 'task', '06FY73YPCJVWBXD9YF1JKZEK2W', 'C4: Clide settings category + enable/disable kill switch', 'The off switch. **Blocks Epic D (T-519)** — deliberately, so the thing that spends
subscription quota cannot land before the thing that stops it.
...
new wiring — just the affordance.', 'in_progress', 'high', NULL, NULL, NULL, '2026-08-09 03:00:37.055', '2026-08-09 11:34:29.230', NULL, 'a3aea6f09fa04723bf486357e06e3056', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY8XTDQ9HXXA1PA6KRG5FFHM', 'task', '06FY73YPCJVWBXD9YF1JKZEK2W', 'C5: Clide i18n catalog — chrome strings for en_us and nl_nl', 'Scope reduced by T-527 (2026-08-09). The companion catalog now exists in **both** locales — `assets/i18n/{en_us,nl_nl}/builtin.clide-companion.json` — because `test/a11y/i18n_coverage_test.dart` enforces en_US/nl_NL key parity for every shipped catalog, so there was no way to land the settings labels without landing the Dutch too. The seven `face.semantics.*` keys that had been warning on every boot since T-525 went in with them; the boot log is quiet.

What is left here is whatever later tickets add — and per T-532, the prompt templates may want to live in this namespace as well, which is a much larger translation surface than chrome strings. Read T-532''s i18n note before sizing this.', 'backlog', 'medium', NULL, NULL, NULL, '2026-08-09 03:00:51.770', '2026-08-09 11:34:36.051', NULL, '2056cdd562f79eeb6665b6a3112a8e08', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FY8XRM7XGNMSGTRB1CNZAA8R', 'task', '06FY73YPCJVWBXD9YF1JKZEK2W', 'C4: Clide settings category + enable/disable kill switch', 'The off switch. **Blocks Epic D (T-519)** — deliberately, so the thing that spends
subscription quota cannot land before the thing that stops it.
...
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCWT2NCPV5ZSZAB9MS7J6YW', 'task', '06FB0TNQM5TWC00GW0P3X02HZW', 'Rain uses the markdown code green, not muted body text', 'Requested live on 2026-08-09, after checking the colour reads across every bundled theme.

The rain drew in `globalTextMuted` — body text at low alpha — which made it read as *dimmed text* rather than as its own thing. It now uses `syntaxString`, the same green the markdown reader gives an inline code span.

**Reaching for a syntax token from chrome is the questionable part, and it is deliberate.** The rain is the one surface in the app that is literally falling code, so the token that means ''this is code'' is the honest one, and borrowing it keeps the rain in step with whatever theme is loaded instead of approximating one theme''s idea of green. The alternative — a new `companionRain` surface token — is more correct by the letter of the theme rules but adds a token every theme author has to fill in for one consumer. Revisit if a second chrome surface ever wants the same colour.

**The face stays `globalForeground`** (option A of three rendered side by side). The face is the character and the rain is the weather (D-107 commitment 5); giving them one colour undoes the separation the vignette exists to create, and it fails worst at high density — exactly when the face most needs to read. `rage` and `error` keep their status colours under any choice; those two say something the palette should not be able to argue with.

Goldens regenerated. Full suite 8 + 4163 + 50.', 'backlog', 'low', NULL, NULL, 'D-107', '2026-08-09 12:15:41.227', '2026-08-09 12:15:41.227', NULL, '587eafc9806a8d16ccb329e55b7eb5c9', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCWT2NCPV5ZSZAB9MS7J6YW', 'task', '06FB0TNQM5TWC00GW0P3X02HZW', 'Rain uses the markdown code green, not muted body text', 'Requested live on 2026-08-09, after checking the colour reads across every bundled theme.
...
Goldens regenerated. Full suite 8 + 4163 + 50.', 'done', 'low', NULL, NULL, 'D-107', '2026-08-09 12:15:41.227', '2026-08-09 12:15:45.559', NULL, 'b6739ce2f96b338447d94ccf16ab7086', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCY5SZ7W4QPN4X1E7YEG8W0', 'task', '06FB0TNQM5TWC00GW0P3X02HZW', 'Speech bubble edge takes the rain green', 'Follow-on to T-535, same session. The bubble''s border was `dividerColor`, which made it read as one more framed panel that happened to contain text. Taking the rain''s `syntaxString` green makes it read as **Clide''s** — the border is the only part of the bubble that can carry identity, since the fill has to stay a readable surface behind body text.

Border only, not fill: a green fill would fight the message it contains, and the message is the point.

Goldens regenerated. Full suite 8 + 4163 + 50.', 'backlog', 'low', NULL, NULL, 'D-107', '2026-08-09 12:21:39.449', '2026-08-09 12:21:39.449', NULL, '248902e7d4f21013541661366def0f50', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCY5SZ7W4QPN4X1E7YEG8W0', 'task', '06FB0TNQM5TWC00GW0P3X02HZW', 'Speech bubble edge takes the rain green', 'Follow-on to T-535, same session. The bubble''s border was `dividerColor`, which made it read as one more framed panel that happened to contain text. Taking the rain''s `syntaxString` green makes it read as **Clide''s** — the border is the only part of the bubble that can carry identity, since the fill has to stay a readable surface behind body text.
...
- The idle timer must not itself keep the loop alive: a `Timer` that fires every
  second to check whether things are quiet is the failure this rung exists to
  prevent.', 'in_progress', 'medium', NULL, NULL, 'D-107', '2026-08-09 12:27:39.955', '2026-08-09 13:37:43.438', NULL, '8725eca67151312285264ac94b5f0ecc', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCZHT6CG6NY0W2Y9AAGMCCG', 'task', '06FY73Y5FBHF8QNAXQDJBJ26B0', 'B4: Power ladder — ambient and dormant rungs, each proved to park the loop', 'D-107 commitment 4: the ladder is a contract, not an optimisation. A
continuously animated surface in an IDE must **prove it stops**.
...
- The idle timer must not itself keep the loop alive: a `Timer` that fires every
  second to check whether things are quiet is the failure this rung exists to
  prevent.', 'in_progress', 'medium', NULL, NULL, 'D-107', '2026-08-09 12:27:39.955', '2026-08-09 13:37:47.776', NULL, '91cf1acc713a74cfe231a4362525ad4d', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
...
- `pick_up_prompt_test.dart` asserts the current lead-in; update it with the
  text rather than around it.', 'backlog', 'medium', NULL, NULL, NULL, '2026-08-09 13:41:51.402', '2026-08-09 13:41:51.402', NULL, 'a18efbcea3f16e14ec1c5e5bc224c5db', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCZHT6CG6NY0W2Y9AAGMCCG', 'task', '06FY73Y5FBHF8QNAXQDJBJ26B0', 'B4: Power ladder — ambient and dormant rungs, each proved to park the loop', 'D-107 commitment 4: the ladder is a contract, not an optimisation. A
continuously animated surface in an IDE must **prove it stops**.
...
codebase has nowhere, and is T-541.', 'in_progress', 'medium', NULL, NULL, 'D-107', '2026-08-09 12:27:39.955', '2026-08-09 13:49:22.018', NULL, '085aed9adcc2d7dac129e719297b3ac4', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYCZHT6CG6NY0W2Y9AAGMCCG', 'task', '06FY73Y5FBHF8QNAXQDJBJ26B0', 'B4: Power ladder — ambient and dormant rungs, each proved to park the loop', 'D-107 commitment 4: the ladder is a contract, not an optimisation. A
continuously animated surface in an IDE must **prove it stops**.
...
**Not covered here:** minimise. That needs app-lifecycle observation, which the
codebase has nowhere, and is T-541.', 'review', 'medium', NULL, NULL, 'D-107', '2026-08-09 12:27:39.955', '2026-08-09 13:49:27.526', NULL, '885c50ea29f82512b77f1e011dae381d', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYDGH6NA4M13VHHSSDWN7TZ0', 'task', '06FB0TNQM5TWC00GW0P3X02HZW', 'Pick-up prompt should state the whole loop — status, /git-commit, leave in review', '`pickUpPrompt` (`lib/builtin/tickets/src/pick_up_prompt.dart:25`) opens with one
line — "Pick up and start working this ticket. Read it fully, then begin." — and
says nothing about how the work should *end*. So the ending is improvised each
time: sometimes the ticket is closed, sometimes left open, sometimes committed
...
The failure this prevents is a companion that talks about the tooling instead of the work — the surest way to make an ambient surface annoying.', 'backlog', 'high', NULL, NULL, 'D-107', '2026-08-09 14:31:27.330', '2026-08-09 15:55:20.209', NULL, 'd844e9040a361281c4fde91885134c63', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYDVZ67S9VM9Y5JZ0HNSMAN4', 'task', '06FY73Z35AYAJQZ4MZMT25DPWC', 'D3: Trigger policy — notable events, frequency, debounce', 'When Clide is *asked* to say something. Blocked by **T-546** — there has to be a
digest before there is anything to remark on.
...
Worth stating because the signals are now conveniently available (T-557 surfaces turn outcome, T-551 forwards binding changes) and ''we can see it, so let us comment on it'' is exactly how an ambient surface becomes a nuisance. Availability is not a reason to speak.', 'backlog', 'medium', NULL, NULL, 'D-107', '2026-08-09 14:31:49.567', '2026-08-09 15:55:29.160', NULL, '63afe8b6399127244936a874e01e249f', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYE0K9R40T1948C780FKDAQ8', 'task', '06FYE0FWH7B6FN89P3THTVCZTM', 'R3: Move the companion load adapter onto the reader', '`clide_companion/src/load_adapter.dart` (T-538) — busy state via the orchestrator, published to the bus.

The smallest of the three and the most recently written; it was produced by copying the meta sidebar, which is the clearest evidence the rule was spreading rather than being shared.

Its nine tests cover the exact hazards the interface is meant to own — rebinding without double-subscribing, absence publishing rather than staying silent, the stamped turn-start surviving a mid-turn rebind. **They must pass unmodified**; they are the closest thing to a specification for the interface''s rebinding behaviour.', 'in_progress', 'medium', NULL, NULL, NULL, '2026-08-09 14:52:02.881', '2026-08-09 15:55:48.799', NULL, 'eca3710188fc3e856e1ca6e6134340f0', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYE0K9R40T1948C780FKDAQ8', 'task', '06FYE0FWH7B6FN89P3THTVCZTM', 'R3: Move the companion load adapter onto the reader', '`clide_companion/src/load_adapter.dart` (T-538) — busy state via the orchestrator, published to the bus.

The smallest of the three and the most recently written; it was produced by copying the meta sidebar, which is the clearest evidence the rule was spreading rather than being shared.

Its nine tests cover the exact hazards the interface is meant to own — rebinding without double-subscribing, absence publishing rather than staying silent, the stamped turn-start surviving a mid-turn rebind. **They must pass unmodified**; they are the closest thing to a specification for the interface''s rebinding behaviour.', 'in_progress', 'medium', NULL, NULL, NULL, '2026-08-09 14:52:02.881', '2026-08-09 15:55:54.724', NULL, 'dc49e710e087039def91abf1205e9a46', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYE0K9R40T1948C780FKDAQ8', 'task', '06FYE0FWH7B6FN89P3THTVCZTM', 'R3: Move the companion load adapter onto the reader', '`clide_companion/src/load_adapter.dart` (T-538) — busy state via the orchestrator, published to the bus.
...
Full suite 8 + 4235 + 50.', 'in_progress', 'medium', NULL, NULL, NULL, '2026-08-09 14:52:02.881', '2026-08-09 16:00:35.322', NULL, 'ffb19e3c20cb96c2d9fe6b2e7de77583', 2) ON CONFLICT(record_id) DO UPDATE SET type=excluded.type, parent_record_id=excluded.parent_record_id, title=excluded.title, description=excluded.description, status=excluded.status, priority=excluded.priority, assigned_to=excluded.assigned_to, team=excluded.team, decision_ref=excluded.decision_ref, updated_at=excluded.updated_at, deleted_at=excluded.deleted_at, hash=excluded.hash, canonical_version=excluded.canonical_version WHERE excluded.updated_at >= tickets.updated_at;
INSERT INTO tickets (record_id, type, parent_record_id, title, description, status, priority, assigned_to, team, decision_ref, created_at, updated_at, deleted_at, hash, canonical_version) VALUES ('06FYE0K9R40T1948C780FKDAQ8', 'task', '06FYE0FWH7B6FN89P3THTVCZTM', 'R3: Move the companion load adapter onto the reader', '`clide_companion/src/load_adapter.dart` (T-538) — busy state via the orchestrator, published to the bus.
